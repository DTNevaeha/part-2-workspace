...
public class EmployeeFactoryTest {
  ...
  public void testCreateEmployeeSalaried() {
    SalariedEmployee emp = (SalariedEmployee) EmployeeFactory.createEmployee(seMap); //creates a salaried employee
    assertEquals("Jackie", emp.getName());
    assertEquals(Date.valueOf("1990-08-24"), emp.getHireDate());
    assertEquals(50000.0, emp.getSalary(), 0.001); //0.001 is a tolerance level
  }
  ...
  public void testCreateEmployeeHourly() {
    HourlyEmployee emp = (HourlyEmployee) EmployeeFactory.createEmployee(heMap); //creates a salaried employee
    assertEquals("Jackie", emp.getName());
    assertEquals(Date.valueOf("1990-08-24"), emp.getHireDate());
    assertEquals(50.0, emp.getRate(), 0.001); //0.001 is a tolerance level
  ...
  public void testCreateEmployeeInvalidTypeThrowsIllegalArgumentException() {
    var invalidInput = Map.of("type", "SO",
